...
public class TitleDeedCard {
    ...
    public String toString() {
        ...
        sb.append("With 2 Houses: $").append(houseRents[1]).append("\n");
        sb.append("With 3 Houses: $").append(houseRents[2]).append("\n");
        sb.append("With 4 Houses: $").append(houseRents[3]).append("\n");
        sb.append("With Hotel: $").append(hotelRent).append("\n");
        sb.append("Mortgage Value: $").append(mortgageValue).append("\n");
        sb.append("Houses cost $").append(houseCost).append(" each\n");
        if (isMortgaged) {
            sb.append("MORTGAGED\n");
